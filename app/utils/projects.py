    ...
    return [
        {
            ...
            "app_ids": ["circa_haus"],
            "provider_set": {
                # Core platform and service providers.
                "supabase": True,
                "stripe": True,
                "openai": True,
                "elevenlabs": True,
                "canva": True,
                "creative_fabrica": True,
                "cloudflare": True,
                ...
                "apple_push_notification_service": True,
                "sentry": True,
                "render": True,
                # Fulfillment / POD roster. These flags describe Circa Haus's
                # integration universe; ether_fronted remains false until the
                # production app is actually routed through Ether.
                "apliiq": True,
                "contrado": True,
                "customcat": True,
                "gelato": True,
